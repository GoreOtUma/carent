...
@router.post("/returns", response_model=ReturnCarResponse, tags=["Возвраты автомобилей"])
...
@router.get("/returns/{return_id}", response_model=ReturnCarResponse, tags=["Возвраты автомобилей"])
...
@router.put("/returns/{return_id}", response_model=ReturnCarResponse, tags=["Возвраты автомобилей"])
